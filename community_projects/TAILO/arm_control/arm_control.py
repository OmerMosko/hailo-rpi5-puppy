...
DXL_ANGLE_POSITION_MUL = 180/1024
...
def set_arm_angle(angle, motor_id):
    ...
    while 1:
        ...
        if abs(angle - arm_present_position) < DXL_MOVING_STATUS_THRESHOLD:
            break
    return True

if(enable_arm() == False):
    quit()
if (set_arm_horizontal_angle(80) == False):
    disable_arm()
    quit()
time.sleep(1)
if(set_arm_horizontal_angle(40) == False):
    disable_arm()
    quit()
disable_arm()
quit()